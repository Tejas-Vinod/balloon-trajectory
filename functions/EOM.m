function state_dot = EOM(t, state, p_i, V_i, C_d, m, T_i, windInterpU, windInterpV, lat0, lon0)
    pos = state(1:3); % [x, y, z]
    ...
    % Interpolated Wind at current alt, lat, lon
    u_wind = windInterpU(z, lat, lon);
    v_wind = windInterpV(z, lat, lon);
